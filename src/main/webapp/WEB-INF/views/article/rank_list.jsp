...
<div>
	...
	<div class="dropdown" id="mydropdown">
	  ...
	  <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
	    <li role="presentation"><a role="menuitem" tabindex="-1" href="#" onclick = "set_rate(1)">HeadLine</a></li>
	    <li role="presentation"><a role="menuitem" tabindex="-1" href="#" onclick = "set_rate(30)">30%</a></li>
	    <li role="presentation"><a role="menuitem" tabindex="-1" href="#" onclick = "set_rate(40)">40%</a></li>
	    <li role="presentation"><a role="menuitem" tabindex="-1" href="#" onclick = "set_rate(50)">50%</a></li>
	  </ul>
	</div>
</div>
